...
export function LoginPage() {
  ...
  const handleLogin = async (admin = false) => {
    await login(admin ? "admin" : "learner");
  ...
  return (
    <div className="auth-page">
      <section className="auth-card">
        ...
        <button className="button primary full" onClick={() => void handleLogin()}>Войти как ученик <ArrowRight size={18} /></button>
        <button className="text-button" onClick={() => void handleLogin(true)}>Демо-вход редактора</button>
