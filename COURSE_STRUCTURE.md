...
Пользовательский ритм курса и группировка всех 77 единиц покрытия в одно вводное и 28 полноценных занятий зафиксированы в `docs/curriculum/ACCOUNTING_KZ_SESSION_PLAN.md`. Пункты roadmap не должны отображаться ученику как отдельные 5–12-минутные уроки.
